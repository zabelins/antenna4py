...
\t1: изменение амплитуд - синусоидальные помехи
\t2: изменение амплитуд - меандровые помехи
\t3: изменение амплитуд - импульсные помехи
\t4: изменение углов - линейный закон для одной помехи
\t5: изменение параметров - случайная одиночная помеха
\t6: изменение параметров - случайная мерцающая помеха
\t7: изменение параметров - случайные временные ряды
\t0: выход из программы"""
